...
public class DatabaseReport extends SQLiteOpenHelper {
    ...
    public static final String databasename="Report";
    ...
    public static final String User_select="selects";

    public DatabaseReport(Context context){
        super(
                context,
                databasename,
                null,
    ...
    public void onCreate(SQLiteDatabase database) {
        String user_query;
        user_query="CREATE TABLE IF NOT EXISTS "+User_table+"(Name TEXT,Email TEXT PRIMARY KEY,Password TEXT,Phone TEXT,selects TEXT )";
    ...
    public boolean Report_Data(String name,String email,String password,String mobile,String selects){
