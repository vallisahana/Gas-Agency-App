...
public class ViewdisdetailsActivity extends AppCompatActivity {

    ListView listView;
    SQLiteDatabase sqLiteDatabase;
    DatabaseVendor dbh;
    Cursor res;
    Vendor_ListAdapter la;
    EditText search;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewdisdetails);
        ...
        res = dbh.UserData();
        la = new Vendor_ListAdapter(getApplicationContext(), R.layout.vendor_row);
        ...
        if (res.moveToFirst()) {
            do {
                ...
                Dataprovider_Vendor DPC = new Dataprovider_Vendor(name, email, password, phone);
                la.add(DPC);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (res1.getCount() > 0) {
                    ...
                    Toast.makeText(ViewdisdetailsActivity.this, "Not found", Toast.LENGTH_LONG).show();
                    return;
        ...
        btnsearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (res2.moveToFirst()) {
                    ...
                    Toast.makeText(ViewdisdetailsActivity.this, "Please enter valid Name", Toast.LENGTH_LONG).show();
                    return;
                }
        ...
        btndelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (res2.getCount() > 0 && !res2.equals(res2)) {
                    Toast.makeText(ViewdisdetailsActivity.this, "Enter vaild Name", Toast.LENGTH_LONG).show();
                    return;
                } else {
                    Toast.makeText(ViewdisdetailsActivity.this, "Successfully Deleted refresh to View", Toast.LENGTH_LONG).show();
                    return;
