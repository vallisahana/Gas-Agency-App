...
public class Vendor_ListAdapter extends ArrayAdapter {

    List list=new ArrayList();
    public Vendor_ListAdapter
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(row==null)
        {
            ...
            row=layoutInflater.inflate(R.layout.vendor_row,parent,false);
       ...
       Dataprovider_Vendor DPC = (Dataprovider_Vendor) this.getItem(position);
